...
@section('content')
    ...
    <div class="container-xxl container-p-y">
        ...
        <div class="d-flex align-items-center py-2">
            <a href="{{ route('lokasi.pegawai') }}" class="btn btn-icon back">
            ...
            <div class="col-xl">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Detail Lokasi {{ Auth::user()->name }}</h5>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex justify-content-between">
                                <a type="button" class="btn btn-primary px-4 mt-3" href="{{ route('lokasi.pegawai') }}">Back</a>
                            </div>
                        </div>
                    </div>
                </div>
