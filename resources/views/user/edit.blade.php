                    ...
                    <div class="card-body">
                        <form action="{{ route('user.update', $user->id) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-md-9 mb-2">
                                    <div class="card border" style="max-width: 14rem; max-height: 14rem;">
                                        <img src="/imageUser/{{ $user->image }}" class="card-img" alt="Profile"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="basic-default-nip" name="nip"
                            ...
                            <div class="mb-3">
                                ...
                                <select id="defaultRole" class="form-select" name="roles[]">
                                    @foreach ($roles as $role)
                                        <option {{ $user->roles->contains('name', $role) ? 'selected' : '' }}>
                                            {{ $role }}
                                        </option>
                                    @endforeach
                                </select>                                                                
