                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{ route('jabatan.store') }}" method="POST" autocomplete="off">
                            @csrf
                            <div class="mb-3">
                                <label class="form-label" for="basic-default-detail">Keterangan
                                    <span class="star">*</span>
                                </label>
                                <input type="text" class="form-control" id="basic-default-detail" name="detail" required autofocus/>
                            </div>
                            <div class="mb-3">
