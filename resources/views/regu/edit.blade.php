        ...
        <div class="row">
            <div class="col-xl">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{ route('regu.update', $regu->id) }}" method="POST" autocomplete="off">
                            @csrf
                            @method('PUT')
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="basic-default-fullname" name="name" value="{{ $regu->name }}" required/>
                            </div>
